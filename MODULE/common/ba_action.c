...
(pMacEntry->WepStatus == Ndis802_11WEPDisabled || pMacEntry->WepStatus == Ndis802_11Encryption3Enabled || pMacEntry->WepStatus == Ndis802_11Encryption2Enabled
#ifdef WPAI_SUPPORT
	...
	{
		DBGPRINT(RT_DEBUG_TRACE,("%s==>(Wcid = %d) PortSecured == WPA_8021X_PORT_SECURED\n",__FUNCTION__,Elem->Wcid)); 
	}
	else
	{
		DBGPRINT(RT_DEBUG_TRACE,("%s==>(Wcid = %d) PortSecured != WPA_8021X_PORT_SECURED\n",__FUNCTION__,Elem->Wcid));

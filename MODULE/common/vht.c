...
INT build_vht_cap_ie(RTMP_ADAPTER *pAd, UCHAR *buf)
{
	...
	if (pAd->chipCap.FlgHwTxBfCap) 
	{
		...
		DBGPRINT(RT_DEBUG_TRACE, ("*****[1]vht_cap_ie.num_snd_dimension= %d\n",vht_cap_ie.vht_cap.num_snd_dimension));
		DBGPRINT(RT_DEBUG_TRACE, ("*****[2]vht_cap_ie.cmp_st_num_bfer= %d\n",vht_cap_ie.vht_cap.cmp_st_num_bfer));
		DBGPRINT(RT_DEBUG_TRACE, ("*****[3]vht_cap_ie.bfee_cap_su= %d\n",vht_cap_ie.vht_cap.bfee_cap_su));
		DBGPRINT(RT_DEBUG_TRACE, ("*****[4]vht_cap_ie.bfer_cap_su= %d\n",vht_cap_ie.vht_cap.bfer_cap_su));
	} 
#endif

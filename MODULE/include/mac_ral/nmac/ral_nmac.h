...
#define TxWISounding            TXWI_N.Sounding
#define TxWIeTxBF               TXWI_N.eTxBF
#define TxWIiTxBF               TXWI_N.iTxBF
#define TxWINDPSndBW            TXWI_N.NDPSndBW
#define TxWINDPSndRate          TXWI_N.NDPSndRate
